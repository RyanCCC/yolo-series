"""
Export a YOLOV7 Pytorch model to ONNX
"""
import os
import subprocess
import sys
...
def export_onnx(model, file, opset, train, dynamic, simplify, prefix='\033[91m'):
    ...
    try:
        ...
        im = torch.zeros(1, 3, *YOLOV7Config.input_shape).to('cpu')  # image size(1, 3, 512, 512) BCHW
        torch.onnx.export(
            model, 
            im, 
            file, 
...
def export_model(
    ...
    yolov5 = Inference_YOLOV7Model(YOLOV7Config, weights).net
