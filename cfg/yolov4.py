...
class YOLOV4Config(Config):
    ...
    learning_rate = 1e-3
    pretrained = False
    pretrain_weight = './yolov4/checkpoints/yolo4_voc_weights.pth'
    save_weight = 'voc.pth'
...
class YOLOV4TinyConfig(Config):
    ...
    learning_rate = 1e-3
    pretrained = False
    pretrain_weight = './yolov4/checkpoints/yolov4_tiny_weights_coco.pth'
    save_weight = 'voc.pth'
    anchors_path = './yolov4/data/yolo_anchors_tiny.txt'
